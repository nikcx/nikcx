...
username = "nikcx" # Github Username (for fetching most of the stuff)
tagline = "NicK" # Second text after rainbow animation
# \/ Self-explanatory
prompt = f"{Style.BRIGHT}{Fore.BLUE}-[{Fore.WHITE}{username}{Fore.BLUE}@{Fore.WHITE}readme{Fore.BLUE}]>{Style.RESET_ALL} "
dob = (2, 6, 2001) # Date of birth
...
github_neofetch = [ 
    ...
    ["OS", "[Windows 11, Android 14, Ubuntu 21.04]"],
    ["", ""],
    ["Contact", None],
    ["E-Mail", "nikcx00@gmail.com"],
    ["Discord", "nicksdr"],
    ["Telegram", "NicKSDRX"],
    ["", ""],
...
t.gen_text(f"nikc (c) {d.year}", 2, count=12)
